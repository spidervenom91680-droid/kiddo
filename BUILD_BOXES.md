# KH4 / Lyra build boxes

Grab these from `spidervenom91680-droid/kiddo`. Forward packages only. **Change nothing that already runs.**

| Box | Path | What | Install word |
|---|---|---|---|
...
Existing stub files (`OPENCODE_KIDDO_INPUT_RESTORE.md`, `backup_manager.py`) are untouched.
